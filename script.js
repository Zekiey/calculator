 ...
 this.previousOperand =''
    ...
    getDisplayNumber(){
        ...
        if(isNaN(integerDigits)){
            integerDisplay = ''
        }else{  integerDigits.toLocaleString('en',{
    ...
    updateDisplay(){this.currentOperandTextElement.innertext=this.getDisplayNumber (this.currentOperand)
